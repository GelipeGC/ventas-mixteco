...
<head>
    ...
    <link href="{{ asset('assets/css/custom_pdf.css')}}" rel="stylesheet" type="text/css" id="dark-style" />
    <link href="{{ asset('assets/css/custom_page.css')}}" rel="stylesheet" type="text/css" id="dark-style" />
...
<body>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2" class="text-center">
                    <span style="font-size: 25px; font-weight: bold;">Sistema Ventas Mixteco</span>
                </td>
            </tr>
            <tr>
                <td width="30%" style="vertical-align: top; padding-top:10px; position:relative">
                    <img src="{{ asset('assets/images/logo_sm.png')}}" alt="" class="invoice-logo">
                </td>
    ...
    <section style="margin-top: -110px">
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tfoot>
                <tr>
                    <td class="text-center"><span><b>TOTALES</b></span></td>
