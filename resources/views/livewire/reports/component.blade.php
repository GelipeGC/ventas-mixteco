                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <a href="{{ url('report/pdf' . '/' . $userId . '/' . $reportType . '/' . $dateFrom . '/' . $dateTo)}}" class="btn btn-dark btn-block {{count($data) < 1 ? 'disabled' : ''}}" target="_blank">Generar PDF</a>
                                <a href="{{ url('report/excel' . '/' . $userId . '/' . $reportType . '/' . $dateFrom . '/' . $dateTo)}}" class="btn btn-dark btn-block {{count($data) < 1 ? 'disabled' : ''}}" target="_blank">Exportar a excel</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $d)
                                        <tr>
                                            ...
                                            <td><h6>{{number_format($d->total, 2)}}</h6></td>
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        ...
        window.livewire.on('error-report', msg => {
            noty(msg, 2)
       });
    })
</script>
